<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBooks.aspx.cs" Inherits="Library.Web.Admin.EditBooks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView runat="server" ID="GridViewBooks" ItemType="Library.Web.Models.Book" SelectMethod="GridViewBooks_GetData" UpdateMethod="GridViewBooks_UpdateItem" DeleteMethod="GridViewBooks_DeleteItem" AllowSorting="True" AllowPaging="True" PageSize="5" AutoGenerateColumns="false" DataKeyNames="ID">
        <Columns>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanelInsertBook" CssClass="panel">
        ...
        <ContentTemplate>
            <asp:FormView runat="server" ID="FormViewIsertBook" DefaultMode="Insert" ItemType="Library.Web.Models.Book"
                ...
                <InsertItemTemplate>
                    ...
                    <div>
                        <span>Category:</span>
                        <asp:DropDownList runat="server" ID="DropDownListCategoriesCreate" DataTextField="Name" DataValueField="ID" ItemType="Library.Web.Models.Category" SelectedValue="<%#: BindItem.Id %>" SelectMethod="DropDownListCategoriesCreate_GetData">
                        </asp:DropDownList>
                    </div>
