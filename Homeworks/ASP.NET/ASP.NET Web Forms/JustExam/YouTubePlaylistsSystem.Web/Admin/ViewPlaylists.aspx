<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewPlaylists.aspx.cs" Inherits="YouTubePlaylistsSystem.Web.Private.ViewArticles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ListView runat="server" ID="lvArticles"
        ...
        <ItemTemplate>
            ...
            <p><%# Item.Rates.Count() %></p>
            <i>by <%#: Item.User.UserName %> on: <%# Item.DateCreated %></i>
        </ItemTemplate>
        <EditItemTemplate>
            <h2>
            ...
            <p>
                <asp:TextBox runat="server" ID="tbEditContent" Text="<%#: BindItem.Description %>" TextMode="MultiLine" Rows="7" Width="100%" />
            </p>
        ...
        <InsertItemTemplate>
            ...
            <p>
                Content:
                <asp:TextBox runat="server" ID="tbEditContent" Text="<%#: BindItem.Description %>" TextMode="MultiLine" Rows="5" />
            </p>
