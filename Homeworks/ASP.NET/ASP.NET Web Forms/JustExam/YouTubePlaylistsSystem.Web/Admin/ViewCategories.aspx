<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewCategories.aspx.cs" Inherits="YouTubePlaylistsSystem.Web.Private.ViewCategories" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView runat="server" ID="gvCategories"
        ...
        <Columns>
            <asp:BoundField SortExpression="Id" DataField="Id" HeaderText="Sort by Id" />
            <asp:BoundField SortExpression="Name" DataField="Name" HeaderText="Sort by name" />
            <asp:BoundField SortExpression="Playlists.Count" DataField="Playlists.Count" HeaderText="Sort by playlists" />
