namespace Computers.Manufactorers
{
    ...
    public class DellComputersFactory : IComputersFactory
    {
        ...
        public Laptop CreateLaptop()
        {
            ...
            var laptop = new Laptop(new Cpu(8 / 2, 32, ram2, videoCard1), ram2, new[] { new HardDriver(1000, false, 0) }, videoCard1, new LaptopBattery());
        ...
        public Server CreateServer()
        {
            ...
            var server = new Server(new Cpu(8, 64, ram1, card), ram1, new List<HardDriver> { new HardDriver(0, true, 2, new List<HardDriver> { new HardDriver(2000, false, 0), new HardDriver(2000, false, 0) }) }, card);
