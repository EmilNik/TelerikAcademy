    ...
    where T : IComparable
    {
        ...
        public int Rows
        {
            ...
            private set
            {
                if (value < 1)
                {
                    throw new ArgumentOutOfRangeException("rows count", "The matrix has 0 rows.");
                }
                this.rows = value;
            }
        }
        ...
        public int Cols
        {
            ...
            private set
            {
                if (value < 1)
                {
                    throw new ArgumentOutOfRangeException("columns count", "The matrix has 0 colums.");
                }
                this.cols = value;
            }
        }
        ...
        public static Matrix<T> operator +(Matrix<T> a, Matrix<T> b)
        {
            ...
            {
                throw new Exception("Addition cannot be applied to a matrix with different dimensions.");
            }
        ...
        public static Matrix<T> operator -(Matrix<T> a, Matrix<T> b)
        {
            if (a.Cols != b.Cols || a.Rows != b.Rows)
            {
                throw new Exception("Substraction cannot be applied to a matrix with different dimensions.");
            }
            Matrix<T> result = new Matrix<T>(a.Rows, a.Cols);
